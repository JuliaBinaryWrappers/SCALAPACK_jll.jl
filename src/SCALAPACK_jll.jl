...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SCALAPACK_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5d3fc3e8-a677-5550-826f-6cfd58f208da"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SCALAPACK", artifacts_toml) for e in artifacts["SCALAPACK"]]
...
if best_platform === nothing
    @debug("Unable to load SCALAPACK; unsupported platform $(triplet(platform_key_abi()))")
else
