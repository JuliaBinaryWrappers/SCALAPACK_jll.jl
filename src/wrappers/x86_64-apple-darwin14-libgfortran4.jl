# Autogenerated wrapper script for SCALAPACK_jll for x86_64-apple-darwin14-libgfortran4
export libscalapack
...
const libscalapack_splitpath = ["lib", "libscalapack.dylib"]
...
const libscalapack = "@rpath/libscalapack.dylib"
